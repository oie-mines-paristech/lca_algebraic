...
def print_data(act):
    ...
    for exc in act.exchanges():
        ...
        if exc.input.key[0] == 'ecoinvent 3.4 cut off' :
            input = eidb.get(exc.input.key[1])
        ...
        if exc['name'] in df.columns:
            ...
            df[name] = [exc.amount, exc.unit, exc.input.key]
...
```{python}
wafer_adjusted = generate_wafer_dataset(SiC_recycled_share=0.4, 
                                        TEG_recycled_share = 0.3, 
                                        DW= True, 
                                        manufacturing_efficiency_gains = 0.2, 
                                        kerf_loss = 0.50, 
                                        wafer_thickness = 240, 
                                        elec_dataset = None,
